...
class goveeApiWrapper {
  ...
  request(endpoint, reqData, method) {
    return new Promise((resolve, reject) => {
      if (this.mac === "") return reject(new Error("MAC Address is Reqired"));
      if (this.model === "") return reject(new Error("Model is Reqired"));
  ...
  setBrightness(brightnessLevel) {
    ...
    if (brightnessLevel > 100)
      throw new Error("Brightness Level Provided is Not From 0-100");
...
module.exports = goveeApiWrapper;
